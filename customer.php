...
<input type="text" name="cname" id="cname" class="form-control rounded-0" pattern="[A-Za-z]+" required oninput="this.value = this.value.replace(/[0-9]/g, '')" />
								</div>
								<div class="mb-3">
								<label class="control-label"># Móvil</label>
								<input type="text" name="mobile" id="mobile" class="form-control rounded-0" pattern="[0-9]{10}" required onfocus="this.placeholder = ''" onblur="if(this.value=='') this.placeholder='Ejemplo: 3245678905'" placeholder="Ejemplo: 3245678905" />
