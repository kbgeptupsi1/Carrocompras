                ...
                <div class="modal-body">
                    <form method="post" id="productForm">
                        ...
                        <label class="control-label">Nombre del Producto</label>
								<input type="text" name="cname" id="cname" class="form-control rounded-0" pattern="[A-Za-z]+" required />
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="tax" id="tax" class="form-control rounded-0" required pattern="[+-]?([0-9]*[.])?[0-9]+" />
                        </div>
                        <div class="form-group">
    ...
    <div id="productViewModal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <form method="post" id="product_form">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><i class="fa fa-th-list"></i> Información del Producto</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
